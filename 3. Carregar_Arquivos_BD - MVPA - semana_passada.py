...
caminho_arquivo = r'G:\Meu Drive\Dados\Traking Integracao\8. Integração\8.3. Integração Panamericano\8.3.3. Bases\8.3.3.3. Consolidado das bases\consolidado.xlsx'
...
nome_tabela = 'traking_integracao_semana_passada'

# Iterar sobre as linhas do DataFrame e inserir os valores na tabela do PostgreSQL
for _, linha in dados_excel.iterrows():
    valores = tuple(linha)
    cur.execute("INSERT INTO traking_integracao_semana_passada VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", valores)
