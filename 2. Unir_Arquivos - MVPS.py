...
pasta = r'G:\Meu Drive\Dados\Traking Integracao\8. Integração\8.4. Integração Irmãos\8.4.3. Bases\8.4.3.2. Bases Tratadas'  # Substitua pelo caminho da pasta desejada
...
caminho_destino = r'G:\Meu Drive\Dados\Traking Integracao\8. Integração\8.4. Integração Irmãos\8.4.3. Bases\8.4.3.3. Consolidado das bases\consolidado.xlsx'  # Substitua pelo caminho desejado
